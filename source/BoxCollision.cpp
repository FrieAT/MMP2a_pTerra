...
BoxCollision::BoxCollision(float fWidth, float fHeight, IPosition* pPosition)
...
bool BoxCollision::colliding(ICollision* pCollisionBody)
{
    ...
    sf::FloatRect a = sf::FloatRect(m_pPosition->GetPosition(),sf::Vector2f(m_fWidth,m_fHeight));
    ...
    sf::Vector2f n = pOther->m_pPosition->GetPosition() - m_pPosition->GetPosition();		// Vector from A to B
